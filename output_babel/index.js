...
var _ = require("./1/1.js");

var _index = _interopRequireDefault(require("./index.css"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { "default": obj }; }

var pagina_vieja = "http://52.7.129.145:3301/";
var numeros = ["Uno", "Dos", "Tres", "Cuadro", "Cinco"];
...
function pindex() {
  ...
  var alerta = function alerta(x) {
    return alert(x);
  };

  var num = document.createElement("div");
  num.innerText = numeros.map(function (number) {
